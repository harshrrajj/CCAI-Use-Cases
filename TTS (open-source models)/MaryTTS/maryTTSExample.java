...
public class maryTTSExample {
    ...
    public static void main(String[] args) throws MaryConfigurationException, marytts.exceptions.SynthesisException, IOException {
        ...
        MaryAudioUtils.writeWavFile(MaryAudioUtils.getSamplesAsDoubleArray(audio), "maryTTS_result.wav", audio.getFormat());  //replace "maryTTS_result.wav" with the file path where you want to store the generated audio on your PC.
